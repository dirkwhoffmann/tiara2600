    ...
    switch (opt) {
        ...
        case OPT_SID_ENABLE:
            ...
            if (objid == 0 && value == false) {
                throw Error(VC64ERROR_OPT_INV_ARG, "SID 0 can't be disabled");
            }
            return;
        ...
        case OPT_SID_ADDRESS:
            ...
            if (objid == 0 && value != 0xD400) {
                throw Error(VC64ERROR_OPT_INV_ARG, "SID 0 can't be remapped");
            }
            if (value < 0xD400 || value > 0xD7E0 || (value & 0x1F)) {
                throw Error(VC64ERROR_OPT_INV_ARG, "D400, D420 ... D7E0");
            }
            return;
        ...
        case OPT_SID_REVISION:
            ...
            if (!SIDRevisionEnum::isValid(value)) {
                throw Error(VC64ERROR_OPT_INV_ARG, SIDRevisionEnum::keyList());
            }
            return;
        ...
        case OPT_SID_ENGINE:
            ...
            if (!SIDEngineEnum::isValid(value)) {
                throw Error(VC64ERROR_OPT_INV_ARG, SIDEngineEnum::keyList());
            }
            return;
